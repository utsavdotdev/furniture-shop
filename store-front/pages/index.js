      ...
      <main className={styles.main}>
        <div className={styles.hero}>
          ...
          <p className={styles.description}>
            Web Storefront made with <b>NextJS</b>; the best developer
            ...
            paired with <b>Medusa</b>; <i>a composable engine</i>
            that combines an amazing developer experience with{" "}
            <i>endless customizations</i> for merchants to scale.
          </p>
        </div>
